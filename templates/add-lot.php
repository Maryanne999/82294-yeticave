  ...
  <form class="form form--add-lot container <?=count($errors) ? 'form--invalid' : '' ?>" action="add.php" method="post"> <!-- form--invalid -->
    ...
    <div class="form__container-two">
      <div class="form__item <?=count($errors) ? 'form__item--invalid' : '' ?>"> <!-- form__item--invalid -->
      ...
      <div class="form__item <?=count($errors) ? 'form__item--invalid' : '' ?>">
 ...
 <?php foreach ($categories as $key => $value) : ?>
    ...
    <div class="form__item form__item--wide <?=count($errors) ? 'form__item--invalid' : '' ?>">
      <label for="message">Описание</label>
      <textarea id="message" name="message" placeholder="Напишите описание лота" required></textarea>
      <span class="form__error"><?=$err_message ; ?></span>
    </div>
    <div class="form__item form__item--file <?=count($errors) ? 'form__item--uploaded' : '' ?>"> <!-- form__item--uploaded -->
    ...
    <div class="form__container-three">
      <div class="form__item form__item--small <?=count($errors) ? 'form__item--invalid' : '' ?>">
